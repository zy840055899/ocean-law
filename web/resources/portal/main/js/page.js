...
var  page = {
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        var oldMiniPageNumber= miniPageNumber;
        ...
        if((oldMiniPageNumber+showPageNum)<=pageCount){
            appendStr+="<li class='"+itemPageClass+"' page-data='"+(pageNumber+1)+"' page-rel='itempage'>...</li>";
            appendStr+="<li class='"+itemPageClass+"' page-data='"+(pageCount)+"' page-rel='itempage'>"+pageCount+"</li>";
        }
